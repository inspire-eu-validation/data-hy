...
| ------------- | ----------------- | ---------- |
| [TG DS Template](./hy-ia/README#ref_TG_DS_tmpl) | [Information accessibility](http://inspire.ec.europa.eu/id/ats/data/master/information-accessibility) | n/a |
...
| ----------------------------------------------------------------- | -------- | ------------ |
| [Units of measure](./uom.md)  | ready for review  | A.2.6  |
