# Conformance class "Application schema, Hydrography - Network 3.1"
...
**URI**: http://inspire.ec.europa.eu/conformance-class/ir/hy/as/hy-n/3.1
...
| ----------------------------------------------------------------- | -------- | ------------ |
| [schema](schema.md)  | Draft  | A.1.1 |
| [code-list-values](code-list-values.md)  | Draft  | A.1.3, A.6.1  |
| [constraints](constraints.md)  | Draft  | A.1.6  |
| [simple-features](simple-features.md)  | Draft  | A.1.7  |
| [geometry](geometry-consistency)  | Draft  | A.1.7  |
| [identifier-and-references](identifier-and-references.md)  | Draft  | A.1.8 |
